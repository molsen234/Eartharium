...
#include "../../EAstronomy/amercury.h"
#include "../../EAstronomy/avenus.h"
#include "../../EAstronomy/amars.h"
#include "../../EAstronomy/ajupiter.h"
...
LLD Astronomy::calcGeo2Topo(LLD pos, LLD loc) {
    // !!! FIX: Here Azi is west of south. In EAstronomy it is east of north. Check Earth.cpp for users of this if changing it. !!!
...
LLD Astronomy::calcDecHA2GP(LLD decra) {
    ...
    // !!! FIX: Does not account for the figure of Earth. !!!
    LLD res = decra;
