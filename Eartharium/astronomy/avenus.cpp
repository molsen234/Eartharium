...
double AVenus::EclipticLongitude(double jd_tt, Ephemeris eph) noexcept {
...
double AVenus::EclipticLatitude(double jd_tt, Ephemeris eph) noexcept {
...
double AVenus::EclipticDistance(double jd_tt, Ephemeris eph) noexcept {
...
LLD AVenus::EclipticCoordinates(double jd_tt, Ephemeris eph) {
