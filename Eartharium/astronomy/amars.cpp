...
double AMars::EclipticLongitude(double jd_tt, Ephemeris eph) noexcept {
...
double AMars::EclipticLatitude(double jd_tt, Ephemeris eph) noexcept {
...
double AMars::EclipticDistance(double jd_tt, Ephemeris eph) noexcept {
...
LLD AMars::EclipticCoordinates(double jd_tt, Ephemeris eph) {
