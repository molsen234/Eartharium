...
double AMercury::EclipticLongitude(double jd_tt, Ephemeris eph) noexcept {
...
double AMercury::EclipticLatitude(double jd_tt, Ephemeris eph) noexcept {
...
double AMercury::EclipticDistance(double jd_tt, Ephemeris eph) noexcept {
...
LLD AMercury::EclipticCoordinates(double jd_tt, Ephemeris eph) {
