...
double AUranus::EclipticLongitude(double jd_tt, Ephemeris eph) noexcept {
...
double AUranus::EclipticLatitude(double jd_tt, Ephemeris eph) noexcept {
...
double AUranus::EclipticDistance(double jd_tt, Ephemeris eph) noexcept {
...
LLD AUranus::EclipticCoordinates(double jd_tt, Ephemeris eph) {
