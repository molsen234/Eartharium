...
class ASun {
public:
	static double GeometricEclipticLongitude(double jd_tt, Ephemeris eph = VSOP87_FULL) noexcept;
	static double GeometricEclipticLatitude(double jd_tt, Ephemeris eph = VSOP87_FULL) noexcept;

	static double GeometricEclipticLongitudeJ2000(double jd_tt, Ephemeris eph = VSOP87_FULL) noexcept;
	static double GeometricEclipticLatitudeJ2000(double jd_tt, Ephemeris eph = VSOP87_FULL) noexcept;

	static double GeometricFK5EclipticLongitude(double jd_tt, Ephemeris eph = VSOP87_FULL) noexcept;
	static double GeometricFK5EclipticLatitude(double jd_tt, Ephemeris eph = VSOP87_FULL) noexcept;

	static double ApparentEclipticLongitude(double jd_tt, Ephemeris eph = VSOP87_FULL) noexcept;
	static double ApparentEclipticLatitude(double jd_tt, Ephemeris eph = VSOP87_FULL) noexcept;
