...
double ANeptune::EclipticLongitude(double jd_tt, Ephemeris eph) noexcept {
...
double ANeptune::EclipticLatitude(double jd_tt, Ephemeris eph) noexcept {
...
double ANeptune::EclipticDistance(double jd_tt, Ephemeris eph) noexcept {
...
LLD ANeptune::EclipticCoordinates(double jd_tt, Ephemeris eph) {
