...
{   
    ...
    ////else if (twilight == 0.5f && dotsun > refcos) FragColor = dCol; // Already set up for fallthrough above
    ////else if (twilight == 0.5f && dotsun < -0.309016994375f) FragColor = nCol + 0.05; // Already covered above
    //else if (dotsun > -0.309016994375f && dotsun < refcos) FragColor = ((dotsun + 0.309016994375) / (0.309016994375 + refcos)) * dCol
    //    + (1.0f - ((dotsun + 0.309016994375) / (0.309016994375 + refcos))) * (nCol + 0.05);
    ...
    //FragColor = texture(nightTexture, TexCoord);
